...
//---------------------Day 2-------------------------------------------
var dayTimer = {
    session1StartTime:new Date("August 11, 2021 11:00:00 GMT-0400").getTime(),
    session1EndTime:new Date("August 11, 2021 11:45:00 GMT-0400").getTime(),
    s1StopTimer:0,
    session2StartTime:new Date("August 11, 2021 12:15:00 GMT-0400").getTime(),
    session2EndTime:new Date("August 11, 2021 13:15:00 GMT-0400").getTime(),
    s2StopTimer:0,
    session3StartTime:new Date("August 11, 2021 13:30:00 GMT-0400").getTime(),
    session3EndTime:new Date("August 11, 2021 14:30:00 GMT-0400").getTime(),
    s3StopTimer:0,
    session4StartTime:new Date("August 11, 2021 14:45:00 GMT-0400").getTime(),
    session4EndTime:new Date("August 11, 2021 15:15:00 GMT-0400").getTime(),
    s4StopTimer:0
}
const dayTitle = "";
...
var Session1Opening = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K9JBV26',
    setTags (){
...
var session2Track1 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K9MFMGW',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session2Track2 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K9P9BS6',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session2Track3 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/KD8SQKP',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session3Track1 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/KD2HVRZ',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session3Track2 = {
    ...
    zoomLink: 'https://zoom.us/j/91613831018?pwd=bmRzeTAxWDlWK2dvK2VReGFNRlhqdz09', //must include the http:// or https:// in order to work
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/KDTJS68',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session3Track3 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/KDBQYZC',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
