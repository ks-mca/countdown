...
//---------------------Day 1-------------------------------------------
var dayTimer = {
    session1StartTime:new Date("August 10, 2021 11:00:00 GMT-0500").getTime(),
    session1EndTime:new Date("August 10, 2021 11:45:00 GMT-0500").getTime(),
    s1StopTimer:0,
    session2StartTime:new Date("August 10, 2021 12:15:00 GMT-0500").getTime(),
    session2EndTime:new Date("August 10, 2021 13:15:00 GMT-0500").getTime(),
    s2StopTimer:0,
    session3StartTime:new Date("August 10, 2021 13:30:00 GMT-0500").getTime(),
    session3EndTime:new Date("August 10, 2021 14:30:00 GMT-0500").getTime(),
    s3StopTimer:0
}
...
var Session1Opening = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/KVK5SY8',
    setTags (){
...
var session2Track1 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K7KGN5Q',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session2Track2 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K7DF7QZ',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session2Track3 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K7W6MCY',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session3Track1 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K7GJXWL',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session3Track2 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K7ZBF9W',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
...
var session3Track3 = {
    ...
    stopTimer:0,
    surveyLink:'https://www.surveymonkey.com/r/K9VWJBH',
    setTags (){
        this.countdownTag=this.dTs+'Countdown';
        this.msgTag=this.dTs+'CountMsg';
        this.dayId= this.dTs+'day';
